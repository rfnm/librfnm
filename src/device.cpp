...
exit_eth:
    // with plain fds nobody unwinds these for us anymore (the asio socket members used to
    // close themselves when a throwing constructor destroyed them); both close calls are
    // no-ops when the handle was never opened
